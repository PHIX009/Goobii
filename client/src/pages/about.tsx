          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center bg-brand-primary hover:bg-brand-secondary text-brand-bg font-grandview-bold px-6 py-3 text-lg shadow-lg transition-colors duration-200 gap-2"
                style={{ borderRadius: '12px 4px 12px 12px' }}
                data-testid="cta-ios"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center bg-brand-secondary hover:bg-brand-primary text-brand-bg font-grandview-bold px-6 py-3 text-lg shadow-lg transition-colors duration-200 gap-2"
                style={{ borderRadius: '12px 4px 12px 12px' }}
