      ...
      <AnimatePresence mode="wait" onExitComplete={restoreFocus}>
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            layoutId={`service-${id}`}
            className="relative w-full max-w-4xl bg-[var(--brand-bg)] shadow-2xl will-change-transform"
            style={{ 
              borderRadius: '12px 4px 12px 12px',
              transform: 'translateZ(0)', // Force hardware acceleration
              opacity: 1 // Ensure modal stays opaque
            }}
